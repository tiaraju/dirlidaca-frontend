...
define('api/api',["require", "exports", 'aurelia-framework', 'aurelia-fetch-client'], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1) {
    ...
    var Api = (function () {
        ...
        Api.prototype.saveProblem = function (problem) {
            return this.http.fetch('http://localhost:8080/problem', {
                method: 'POST',
                headers: {
        ...
        Api.prototype.getProblem = function (id) {
            return this.http.fetch("http://localhost:8080/problem/" + id);
        };
        Api.prototype.updateProblem = function (problem) {
            return this.http.fetch('http://localhost:8080/problem', {
                method: 'PUT',
                headers: {
                    'Accept': 'application/json',
...
define('problem/add-problem',["require", "exports", '../api/api', 'aurelia-framework'], function (require, exports, api_1, aurelia_framework_1) {
    "use strict";
    var AddProblem = (function () {
        function AddProblem(api) {
            this.api = api;
        }
        AddProblem.prototype.created = function () {
        };
        Object.defineProperty(AddProblem.prototype, "canSave", {
            get: function () {
        ...
        AddProblem.prototype.addProblem = function () {
            ...
            this.api.saveProblem(newProblem).then(function () {
                alert("Problem added");
                _this.name = "";
                _this.description = "";
                _this.hint = "";
...
define('problem/problem-detail',["require", "exports", 'aurelia-framework', '../api/api'], function (require, exports, aurelia_framework_1, api_1) {
    ...
    var ProblemDetail = (function () {
        ...
        Object.defineProperty(ProblemDetail.prototype, "canUpdate", {
            get: function () {
        ...
        ProblemDetail.prototype.activate = function (params, routeConfig) {
            ...
            this.api.getProblem(params.id).then(function (response) { return response.json(); })
                .then(function (data) {
                _this.problem = data;
            });
        };
        ProblemDetail.prototype.updateProblem = function () {
            var _this = this;
            this.api.updateProblem(this.problem).then(function (response) { return response.json(); })
                .then(function (data) {
                _this.problem = data;
